...
export const MOCK_FIGHTERS: Fighter[] = [
  {
    ...
    photoURL: '', record: '18-3-0', age: 28, stance: 'Orthodox', instagram: '', email: '', uid: null, nationality: 'Australian', status: 'approved' as const,
  },
  {
    ...
    bio: '', photoURL: '', record: '14-5-1', age: 26, stance: 'Southpaw', instagram: '', email: '', uid: null, nationality: 'Australian', status: 'approved' as const,
  },
  {
    ...
    bio: '', photoURL: '', record: '22-8-0', age: 30, stance: 'Orthodox', instagram: '', email: '', uid: null, nationality: 'Australian', status: 'approved' as const,
  },
  {
    ...
    bio: '', photoURL: '', record: '10-2-0', age: 24, stance: 'Orthodox', instagram: '', email: '', uid: null, nationality: 'Australian', status: 'approved' as const,
  },
  {
    ...
    bio: '', photoURL: '', record: '45-12-0', age: 32, stance: 'Orthodox', instagram: '', email: '', uid: null, nationality: 'Australian', status: 'approved' as const,
  },
  {
    ...
    bio: '', photoURL: '', record: '38-9-2', age: 29, stance: 'Orthodox', instagram: '', email: '', uid: null, nationality: 'Australian', status: 'approved' as const,
  },
  {
    ...
    bio: '', photoURL: '', record: '12-2-0', age: 25, stance: 'Orthodox', instagram: '', email: '', uid: null, nationality: 'Australian', status: 'approved' as const,
  },
  {
    ...
    bio: '', photoURL: '', record: '15-4-0', age: 27, stance: 'Southpaw', instagram: '', email: '', uid: null, nationality: 'Australian', status: 'approved' as const,
  },
  {
    ...
    bio: '', photoURL: '', record: '9-1-0', age: 23, stance: 'Orthodox', instagram: '', email: '', uid: null, nationality: 'Australian', status: 'approved' as const,
  },
  {
    ...
    bio: '', photoURL: '', record: '20-3-0', age: 31, stance: 'Orthodox', instagram: '', email: '', uid: null, nationality: 'Australian', status: 'approved' as const,
  },
];
